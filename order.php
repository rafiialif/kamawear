	...
	<?php 
			if(!empty($_POST['form-order'])){
				...
				if($difference->days >= 3){
					...
					?>
	<div class="alert alert-danger">Tanggal Penggunakan terlalu mepet. Pemesanan paling sedikit 3 Hari sebelum hari H.
	</div>
	<?php
				}
			}
			...
			<form action="" method="post" enctype="multipart/form-data">
				...
				<select name="kota" required class="form-control">
					...
					<option value="<?php echo $kp['id']; ?>"><?php echo $kp['nama'] ?> -
						<?php echo "Rp ".number_format($kp['ongkir'], 2, ',', '.'); ?></option>
					<?php } ?>
				</select><br>
				...
				<tbody>
					...
					<tr class="barang-shop">
						<td class="CartProductThumb">
							<div>
								<a href="<?php echo $url; ?>menu.php?id=<?php echo $product['id'] ?>"><img
						...
						<td>
							<div class="CartDescription">
								...
								<div class="price"><?php echo  "Rp ".number_format($product['harga'], 2, ',', '.') ?>
								</div>
							</div>
						</td>
						<td>
